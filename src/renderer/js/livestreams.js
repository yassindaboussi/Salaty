...
function initLiveStreamsPage() {
  console.log('Initializing Live Streams page...');
...
function updateStreamsUI() {
  ...
  const makkahLocationSub = document.querySelector('#panelMakkah .stream-location-sub');
  if (makkahLocationSub) {
    makkahLocationSub.textContent = t('makkahLocation');
  }
  
  const madinaLocationSub = document.querySelector('#panelMadina .stream-location-sub');
